...
DEPARRAY=(mapio numpy scipy openquake.engine matplotlib rasterio pandas shapely h5py gdal psutil pytest pytest pytest-cov pytest-mpl jupyter ipython fiona pyproj)
...
conda create --name $VENV --yes --channel conda-forge python=3.7 ${DEPARRAY[*]} -y
